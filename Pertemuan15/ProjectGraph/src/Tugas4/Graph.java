...
public class Graph {
    ...
    //Menambahkan edge
    public void addEdge(String source, String destination, int index, int index2){ // source = asal, destination = tujuan
        // add edge
        list[index].addFirst(destination); // dari asal akan disambungkan ke tujuan
